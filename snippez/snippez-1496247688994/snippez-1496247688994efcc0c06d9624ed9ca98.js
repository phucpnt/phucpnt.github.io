...
var _highstock = __webpack_require__(0);
...
(function (H) {
  H.wrap(H.Axis.prototype, 'drawCrosshair', function (proceed, e, p) {
    var chart = this.chart,
        M = 'M',
        L = 'L',
        point = chart.hoverPoints && chart.hoverPoints[this.options.index] || p,
        pick = H.pick,
        defined = H.defined,
        path,
    ...
    (defined(point) || !snap) === false) {
      ...
      if (defined(pos)) {
        if (!this.isXAxis) {
          path = [M, point && chart.plotLeft + point.plotX, point.plotY + chart.plotTop, L, this.opposite ? chart.plotLeft + this.chart.xAxis[0].len : chart.plotLeft, point.plotY + chart.plotTop];
        } else {
...
function createChart() {
  ...
  var chart = _highstock2.default.stockChart('container', {
    ...
    tooltip: {
      ...
      formatter: function formatter() {
        return '<span>Click for details</span>';
      }
    },
...
_jquery2.default.each(names, function (i, name) {

  _jquery2.default.getJSON('https://www.highcharts.com/samples/data/jsonp.php?filename=' + name.toLowerCase() + '-c.json&callback=?', function (data) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=snippez-1496247688994efcc0c06d9624ed9ca98.js.map